...
const Home: FC = () => {
  ...
  return (
    <div>
      ...
      <p>
        Painting beautiful interfaces, building tools and crafting polished user
        interactions that feel delightful to use. Besides that, I take photos,
        lift weights and I'm interested in Linux, Vim, alongside other random
        computer things.
      </p>
      <svg
        aria-hidden='true'
      ...
      <p>
        If you're ever near the Dallas-Fort Worth area, let's hang out. Looking
        for new opportunities. Reach out at{' '}
        <a
