...
export const Ethos: FC = () => {
  return (
    <section className={s.ethos}>
      ...
      <p>
        Following passion, living what I love. Enjoys lifting weights, evening
        walks, databases, Linux, Vim, and other random computer things.
      </p>
      <p>
        Feel free to check out my <a href='/uses'>gear</a>, or the{' '}
        <a href='/music'>music</a> I&apos;ve been listening to.
      </p>
      <svg
        aria-hidden='true'
        width='80'
