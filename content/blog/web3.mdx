...
Aside from that, we should all know just [how harmful cryptocurrency is for our environment](https://www.forbes.com/sites/davidrvetter/2021/04/06/bitcoin-could-churn-out-130-million-tons-of-carbon-undermining-climate-action-heres-one-way-to-tackle-that). Here's a fun fact: all the gains we've saved from using renewable sources of energy such as sun power have been reversed in the recent few years from just Bitcoin alone. I can go on about and give different concerning statistics about crypto, but I think you get the point.
