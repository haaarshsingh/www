...
Before we begin, you can now check it out live at over at [kmenu.hxrsh.in](https://kmenu.hxrsh.in), and get started with the documentation over on the [GitHub](https://github.com/harshhhdev/kmenu).
