---
title: 'Add a VSC Command Palette to Your Website!'
tags: 'react,next.js,css,design,ui/ux'
...
And that's it! Feel free to checkout the live demo on [CodeSandbox](https://codesandbox.io/s/command-palette-react-4zsur)
