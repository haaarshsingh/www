...
...and so on, so forth. For a list of all all of these 'bangs', checkout [duckduckgo.com/bang](https://duckduckgo.com/bang).

### See social media information in results

Just type in '@' infront of a user or organisation, and watch the [magic].
...
If those weird characters like 'iCNqGvco43' are too hard to remember for you, which, in all fairness should be, then you can generate a passphrases using 'random passphrase' and maybe find something a bit easier to remember.
