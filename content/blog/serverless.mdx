...
tags: 'react,next.js,vercel,cockroachdb,prisma,databases,typescript,sql,serverless'
...
Live app 👉 [guestbook.hxrsh.in](https://guestbook.hxrsh.in)

Repository 👉 [github/harshhhdev/guestbook](https://github.com/harshhhdev/guestbook)
