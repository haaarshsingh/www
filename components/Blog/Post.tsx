...
const Post: FC<{ blog: Blog }> = ({ blog }) => {
  ...
  return (
    <div className='mt-16'>
      ...
      <h1 className='!text-3xl !text-transparent !bg-clip-text !from-gradient-100 !to-gradient-200 !bg-gradient-to-r'>
        {blog.title}
      </h1>
      <div className='flex justify-between mt-6'>
        ...
        <div className='flex'>
          <div className='text-lg sm:text-base flex justify-center items-center text-gray-400'>
          ...
          <div className='text-lg sm:text-base flex items-center justify-center ml-5 text-gray-400'>
