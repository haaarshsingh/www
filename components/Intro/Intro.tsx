...
import { FadeContainer, FastFadeContainer, Fade } from '@anims/index'
import * as S from './Intro.style'

const Socials: FC = () => {
  return (
    <S.SocialsWrapper variants={FastFadeContainer}>
      {[
        {
          aria: 'GitHub',
          icon: FiGithub,
...
const Intro: FC = () => {
  ...
  return (
    ...
    >
      <S.Avatar
        className={['img', `img--blur-down`, imageLoading && 'is-loaded']
          .filter(Boolean)
          .join(' ')}
      >
        <Image
      ...
      <S.Container>
        <S.DateContainer variants={Fade}>
          ...
          <S.Time right>
            <a
              href='https://en.wikipediorg/wiki/Dallas%E2%80%93Fort_Worth_metroplex'
              target='_blank'
              rel='noreferrer'
            >
              Dallas-Fort Worth
            ...
            ,{' '}
            <a
              href='https://en.wikipediorg/wiki/Texas'
              target='_blank'
              rel='noreferrer'
            >
              Texas
